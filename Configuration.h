...
#define CONFIG_EXAMPLES_DIR "config/examples/Kingroon/KP3S Pro" 
...
#define STRING_CONFIG_H_AUTHOR "(Tumezie)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 844 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 28.0, 2.0, -3.57 }
